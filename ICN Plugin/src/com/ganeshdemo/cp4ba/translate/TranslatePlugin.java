...
public class TranslatePlugin extends Plugin {
	...
	public String getName(Locale locale) {
		return "Translate eng to arabic";
	}
	...
	public String getConfigurationDijitClass() {
		return "translatePluginDojo.ConfigurationPane";
	}
	...
	public PluginResponseFilter[] getResponseFilters() {
		if (pluginResponseFilters.length == 0) {
			pluginResponseFilters = new PluginResponseFilter[] {new com.ganeshdemo.cp4ba.translate.TranslateResponseFilter(), new com.ganeshdemo.cp4ba.casedetailstranslate.CaseDetailsTranslate()};
		}
